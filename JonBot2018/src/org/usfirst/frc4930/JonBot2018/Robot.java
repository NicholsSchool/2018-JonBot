...
public class Robot extends TimedRobot {
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        SmartDashboard.putString("Joy Stick Values : ",  String.valueOf(Robot.oi.j0.getY()));
    	Robot.dtLBMaster.set(.4);
        Robot.dtLFMaster.set(.4);
        Robot.dtRBMaster.set(.4);
        Robot.dtRFMaster.set(.4);
    }
